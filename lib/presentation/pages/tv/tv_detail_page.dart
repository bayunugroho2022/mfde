                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                if (!isAddedWatchlist) {
                                  await Provider.of<TvDetailNotifier>(context,listen: false).addWatchlist(tvSeries);
                                } else {
                                  await Provider.of<TvDetailNotifier>(context,listen: false).removeFromWatchlist(tvSeries);
                                }
